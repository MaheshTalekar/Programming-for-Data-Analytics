...
public class OffenseHourDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.addInputPath(job, new Path("hdfs://localhost:54310/user/hduser/task3"));
        FileOutputFormat.setOutputPath(job, new Path("hdfs://localhost:54310/user/hduser/task3/output"));
